#source of randomness in training neural networks
#1. weight initialization
#2. random shuffling of training data
#3. random sampling of mini-batches
#4. random dropout
#5. random noise added to inputs
#6. Hardware and drivers (GPUs) - use same gpus and drivers else cpu can give a deterministic result
#7. nondeterministic algorithms (e.g. cuDNN) - set deterministic=true in pl.trainer
